...
function SnoopBase.prepare(U::Uncore{NS, NIMC, NCH}, args...) where {NS, NIMC, NCH}
...
function SnoopBase.measure(U::Uncore{NS, NIMC, NCH}) where {NS, NIMC, NCH}
    PCM.sample!(U.monitor)
...
SnoopBase.clean(U::Uncore) = PCM.cleanup()
